...
#
# The character is built from its code point so this file does not contain
# the thing it is looking for. uv.lock is skipped because its content comes
# from package metadata upstream, not from anyone here.
set -euo pipefail
